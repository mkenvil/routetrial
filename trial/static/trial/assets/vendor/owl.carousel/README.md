...
```js
import 'owl.carousel/dist/"{% static 'trial/assets//owl.carousel.css';
import 'owl.carousel';
```
...
```html
<link rel="stylesheet" href="/node_modules/owl.carousel/dist/"{% static 'trial/assets//owl.carousel.min.css" />
```

```html
<link rel="stylesheet" href="/bower_components/owl.carousel/dist/"{% static 'trial/assets//owl.carousel.min.css" />
```
